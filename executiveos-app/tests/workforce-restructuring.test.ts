...
const cognitiveCase: CognitiveCase = {
  ...
  state: "explore",
  signals: { impact: 10, urgency: 8, confidence: 55, cognitiveCost: 9, risk: 9 }
};
...
test("does not issue a recommendation before context is collected", () => {
  ...
  assert.match(result.nextAction, /Documenter les informations bloquantes|diagnostic financier|contexte/i);
