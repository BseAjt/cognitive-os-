...
const cognitiveCase: CognitiveCase = {
  id: "agent-case",
  title: "Architecture ExecutiveOS",
  objective: "Choisir une architecture robuste et différenciante",
  workingHypothesis: "Le runtime unifié réduit la dette technique",
  context: "Le produit doit intégrer mémoire, graphe et agents.",
  state: "decide",
  signals: { impact: 9, urgency: 7, confidence: 72, cognitiveCost: 6, risk: 8 }
};
...
test("ORION selects technology and reflection specialists for a risky architecture question", () => {
  const result = runAgentOrchestration({
    message: "Nous devons choisir l'architecture du runtime. Le risque est un couplage trop fort.",
    cognitiveCase,
    agents: defaultExecutiveAgents,
    extractions: [
      { kind: "risk", text: "Couplage trop fort", confidence: 88 },
